...
int main() {
    ...
    run_all(epoch_based_versions, epoch_based_names, Data_matr, Data_matr_copy, E_vecs, E_vals, 100);
    run_all(tol_based_versions, tol_based_names, Data_matr, Data_matr_copy, E_vecs, E_vals, 1e-8);
}
