...
TEST(evd_tol_cyclic, identity_matrix) {
    size_t n = 10;
    ...
    evd_cyclic_tol(Data_matr, Out_matr, E_vecs, E_vals, 1e-7);
    for (size_t i = 0; i < n; ++i) {
        ASSERT_DOUBLE_EQ(e[i], 1.0);
    }
}

TEST(evd_tol_cyclic, random_square_matrix) {
    size_t n = 4;
...
TEST(evd_tol_cyclic, svd_eigvalues_crosscheck) {
    size_t n = 5;
    std::vector<double> A = {
...
TEST(evd_tol_cyclic, eigenvector_check) {
    size_t n = 5;
    std::vector<double> A = {
        2.000000000000000000e+00, 6.000000000000000000e+00, 4.000000000000000000e+00, 6.000000000000000000e+00,
        4.500000000000000000e+00, 6.000000000000000000e+00, 5.000000000000000000e+00, 8.000000000000000000e+00,
