...
TEST(evd_cyclic_unroll_outer_vectorize, identity_matrix) {
    size_t n = 10;
...
TEST(evd_cyclic_unroll_outer_vectorize, random_square_matrix) {
    size_t n = 4;
...
TEST(evd_cyclic_unroll_outer_vectorize, evd_crosscheck) {
    size_t n = 5;
    std::vector<double> A = {
...
TEST(evd_cyclic_unroll_outer_vectorize, eigenvector_check) {
    size_t n = 5;
    std::vector<double> A = {
        2.000000000000000000e+00, 6.000000000000000000e+00, 4.000000000000000000e+00, 6.000000000000000000e+00,
        4.500000000000000000e+00, 6.000000000000000000e+00, 5.000000000000000000e+00, 8.000000000000000000e+00,
...
TEST(evd_cyclic_unroll_outer_vectorize, random_matrix_big) {
    size_t n = 128;
