...
TEST(evd_cyclic_blocked, identity_matrix) {
    ...
    evd_cyclic_blocked(Data_matr, Data_matr_copy, E_vecs, E_vals, 20);
    for (size_t i = 0; i < n; ++i) {
...
TEST(evd_cyclic_blocked_less_copy, random_matrix_big) {
    ...
    vector_t E_vals = {&e[0], n};
    matrix_t E_vecs = {&V[0], n, n};
    evd_cyclic_blocked_less_copy(Data_matr, Data_matr_copy, E_vecs, E_vals, 20);
...
TEST(evd_cyclic_blocked_unroll_outer, random_matrix_big) {
    ...
    vector_t E_vals = {&e[0], n};
    matrix_t E_vecs = {&V[0], n, n};
    evd_cyclic_blocked_unroll_outer(Data_matr, Data_matr_copy, E_vecs, E_vals, 20);
...
TEST(evd_cyclic_blocked_unroll_outer_less_copy, random_matrix_big) {
    ...
    vector_t E_vals = {&e[0], n};
    matrix_t E_vecs = {&V[0], n, n};
    evd_cyclic_blocked_unroll_outer_less_copy(Data_matr, Data_matr_copy, E_vecs, E_vals, 20);
...
TEST(evd_cyclic_blocked_vectorize, random_matrix_big) {
    ...
    vector_t E_vals = {&e[0], n};
    matrix_t E_vecs = {&V[0], n, n};
    evd_cyclic_blocked_vectorize(Data_matr, Data_matr_copy, E_vecs, E_vals, 20);
...
TEST(evd_cyclic_blocked_less_copy_vectorize, random_matrix_big) {
    ...
    vector_t E_vals = {&e[0], n};
    matrix_t E_vecs = {&V[0], n, n};
    evd_cyclic_blocked_less_copy_vectorize(Data_matr, Data_matr_copy, E_vecs, E_vals, 20);
